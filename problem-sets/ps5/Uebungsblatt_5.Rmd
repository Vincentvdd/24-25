...
# group_by(gender) |>
 ...
 summarize(group_by(mutate(wage1, gender = ifelse(female == 1, "female", "male")), gender), mean(educ))
# enter your code here ...
...
summarize(group_by(jtrain3, unem75), mean(train), mean(unem78))
...
# enter your code here ...
jtrain3_la <- subset(jtrain3, unem75 == 1)
jtrain3_ka <- subset(jtrain3, unem75 == 0)
```
Hier waere ein guter Zeitpunkt das Addin 'Check Problemset' auszufuehren!
